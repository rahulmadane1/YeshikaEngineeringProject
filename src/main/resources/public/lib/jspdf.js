	...
	return {
		...
		output: function(type, options) {
			...
			if (window.navigator.msSaveBlob) { 
			    window.navigator.msSaveOrOpenBlob(blob, 'payemntVoucher' + new Date().toDateString() + '.pdf');
			}
			else {
			    var a = window.document.createElement("a");
			    a.href = window.URL.createObjectURL(blob, { type: "text/html" });
			    a.download = "payemntVoucher" + new Date().toDateString() + ".pdf";
